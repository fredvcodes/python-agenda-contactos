...
def eliminar_contacto(agenda):
    ...
    if nombre in agenda:
        ...
        print("No se ha encontrado un contacto con el nombre {nombre}")

def buscar_contacto(agenda):
    nombre = input("Ingese el nombre que desea buscar: ")
    if nombre in agenda:
...
def agenda_contactos():
    ...
    while True: 
        ...
        if opcion == "1":
            ...
            print("Saliendo de la agenda de contacto ¡Hasta aluego!")
            break
        else:
